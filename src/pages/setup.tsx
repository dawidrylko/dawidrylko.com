...
const setupDiagram = `graph TD
  subgraph MacStation ["Mac Mini 2024 Station"]
    Computer
    Dock
    Dock -- "USB-C ↔ USB-C<br/><small>Original RayCue dock cable</small>" --> Computer
  end

  subgraph SecondaryStation ["Secondary Device Station"]
    Secondary["Secondary Device"]
    Hub
    Secondary -- "USB-C ↔ USB-C<br/><small>Thunderbolt 5, 80 Gbps, PD 240 W, 16K@30 Hz, 0.5m extension</small>" --> Hub
  end
  ...
  Computer -- "USB-C ↔ DisplayPort 1.4<br/><small>UGREEN, 32.4 Gbps, 8K@60 Hz, 1m</small>" --> KVM
  Computer -- "USB-C ↔ USB-C<br/><small>Thunderbolt 5, 80 Gbps, PD 240 W, 16K@30 Hz, 1m</small>" --> KVM

  Hub -- "DisplayPort ↔ DisplayPort<br/><small>Original iiyama cable</small>" --> KVM
  Hub -- "USB-C ↔ USB-C<br/><small>Thunderbolt 5, 80 Gbps, PD 240 W, 16K@30 Hz, 0.5m</small>" --> KVM

  KVM -- "DisplayPort ↔ DisplayPort<br/><small>Original iiyama cable</small>" --> Monitor
  KVM -- "USB-A ↔ USB-B<br/><small>Original iiyama USB hub cable</small>" --> Monitor

  Mouse -- "USB dongle" --> KVM
  Keyboard -- "USB-C ↔ USB-A<br/><small>Original NuPhy keyboard cable</small>" --> KVM
  Microphone -- "USB-B 2.0 ↔ USB-C<br/><small>2 m</small>" --> KVM

  Monitor -- "USB-A ↔ USB-C<br/><small>Original Xiaomi Mi Computer Monitor Light Bar cable</small>" --> Lightbar
`;
