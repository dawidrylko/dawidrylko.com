...
featuredImg: ./ai-w-chrome.webp
featuredImgAlt: A curved desktop monitor on a wooden desk displaying a glowing blue and purple neural network shaped like a human brain, with the letters 'AI' lit up in its center. Below the monitor stands a small desktop computer showing an AI chip icon on its front display.
