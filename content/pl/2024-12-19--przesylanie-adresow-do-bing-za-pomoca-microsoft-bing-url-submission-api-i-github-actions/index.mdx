...
> **Aktualizacja z 7 lipca 2026 r.:** Bing URL Submission API nadal jest obsługiwane i opisany mechanizm pozostaje prawidłowy. Microsoft [zdecydowanie rekomenduje jednak IndexNow](https://www.bing.com/webmasters/help/URL-Submission-62f2860b) dla nowych automatyzacji, ponieważ powiadamia ono Bing i inne uczestniczące wyszukiwarki. Microsoft zaznacza też, że URL Submission API może zostać wycofane w przyszłości. Samo przesłanie adresu nie gwarantuje jego indeksacji.
...
[scripts/notify/bing.sh](https://github.com/dawidrylko/dawidrylko.com/blob/master/scripts/notify/bing.sh)
...
```bash
chmod +x scripts/notify/bing.sh
```
...
[.github/workflows/cd.yml](https://github.com/dawidrylko/dawidrylko.com/blob/master/.github/workflows/cd.yml#L80-L97)
